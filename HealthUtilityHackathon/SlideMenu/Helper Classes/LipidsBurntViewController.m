...
- (void)viewWillAppear:(BOOL)animated {
    ...
    OVGraphViewPoint *fifteenthPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"2 PM" YValue:@8 ];
    OVGraphViewPoint *sixteenthPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"3 PM" YValue:@8 ];
    OVGraphViewPoint *seventeenthPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"4 PM" YValue:@8 ];
    OVGraphViewPoint *eighteenthPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"5 PM" YValue:@8 ];
    OVGraphViewPoint *nineteenthPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"6 PM" YValue:@8 ];
    OVGraphViewPoint *twentyPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"7 PM" YValue:@8 ];
    OVGraphViewPoint *twentyonePoint = [[OVGraphViewPoint alloc]initWithXLabel:@"8 PM" YValue:@8 ];
    OVGraphViewPoint *twentytwoPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"9 PM" YValue:@8 ];
    OVGraphViewPoint *twentythrePoint = [[OVGraphViewPoint alloc]initWithXLabel:@"10 PM" YValue:@8 ];
    OVGraphViewPoint *twentyfourPoint = [[OVGraphViewPoint alloc]initWithXLabel:@"11 PM" YValue:@8 ];
